...
const Tweet = React.createClass({
    ...
    calcFontSize() {
        const total = (this.props.likes || 0) + (this.props.retweets || 0);
        const size =
            (total >= 100 && total < 1000) ? 18
            : (total >= 1000) ? 22
            : 16;
        return size + 'px';
    },
        ...
        return (
            <div className="tweet">
                ...
                <div className="tweet-body">
                    ...
                    <p className="tweet-text" style={{fontSize: this.calcFontSize()}}>
                        {text}
                    </p>
                    ...
                    <div className="tweet-stats">
                        <div className={'tweet-retweets' + (isRetweeted && ' has-new' || '')}>
                            <i className="tweet-stat-icon fa fa-retweet" />
                            {retweets || null}
                        </div>
                        <div className={'tweet-likes' + (isLiked && ' has-new' || '')}>
